...
class iso _TestFifoBasic is UnitTest
  ...
  fun apply(h: TestHelper) =>
     ...
     var mf = MainFifo(h.env)

     let numToProduce: I64 = 10
     let numToConsume: I64 = 10
     let fifoSize: I64 = 2
     let fifo = Fifo(out, fifoSize)

     let p = Producer(out, numToProduce, fifo, mf, h)
     let c = Consumer(out, numToConsume, fifo, mf, h)

     c.start()
     p.start()

     // note: asserts look like this:
