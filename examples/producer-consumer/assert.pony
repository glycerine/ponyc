// a simple assert facility that does not require
// spreading test harnesses TestHelper gunk throughout
// your production code. We endeavor to exit(1)
// the program immediately upon a failed assertion.
